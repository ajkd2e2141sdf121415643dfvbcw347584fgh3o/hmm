...
local function UpdatePositions()
    for i, noti in ipairs(Notifications) do
        local targetPos = UDim2.new(0.5, -300, 0, Padding.PaddingTop.Offset + (i-1) * Y_PADDING)
        TweenService:Create(noti.Frame, TweenInfo.new(0.4, Enum.EasingStyle.Quart), {Position = targetPos}):Play()
    end
end

local function RemoveNotification(noti)
    local index = table.find(Notifications, noti)
    if index then table.remove(Notifications, index) end
    
    local tweenOut = TweenService:Create(noti.Frame, TweenInfo.new(0.5), {Position = UDim2.new(1.5, 0, noti.Frame.Position.Y.Scale, noti.Frame.Position.Y.Offset)})
    tweenOut:Play()
...
function Notify(message, duration)
    ...
    local noti = {Frame = clone, Duration = duration, StartTime = tick()}
...
--[[
    ...
    @buildDate "2026-02-24T04:25:48.865934800+00:00"
    @buildCfg "Beta"
    @buildVers "v1.1.0-beta.1"
...
type App__DARKLUA_TYPE_r = AppProperties__DARKLUA_TYPE_q & Components__DARKLUA_TYPE_7

type WindowProperties__DARKLUA_TYPE_s = Frame__DARKLUA_TYPE_g & {
	Searching: boolean?,
	Draggable: boolean?,
	Resizable: boolean?,
	Title: string?,
...
type Window__DARKLUA_TYPE_t = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & WindowProperties__DARKLUA_TYPE_s

type SectionProperties__DARKLUA_TYPE_u = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Disclosure: boolean?,
	Expanded: boolean?,
}

type Section__DARKLUA_TYPE_v = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & SectionProperties__DARKLUA_TYPE_u

type TabProperties__DARKLUA_TYPE_w = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Icon: string?,
	Indentation: number?,
	Selected: boolean?,
	Page: Page__DARKLUA_TYPE_J?,
}

type Tab__DARKLUA_TYPE_x = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & TabProperties__DARKLUA_TYPE_w & {
	Navigate: (self: Tab__DARKLUA_TYPE_x, page: Page__DARKLUA_TYPE_J) -> nil,
}

type FormProperties__DARKLUA_TYPE_y = Frame__DARKLUA_TYPE_g

type Form__DARKLUA_TYPE_z = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & FormProperties__DARKLUA_TYPE_y

type RowProperties__DARKLUA_TYPE_A = Frame__DARKLUA_TYPE_g & {
	SearchIndex: string?,
}

type Row__DARKLUA_TYPE_B = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & RowProperties__DARKLUA_TYPE_A & {
	Left: (self: Row__DARKLUA_TYPE_B) -> Row__DARKLUA_TYPE_B,
	Right: (self: Row__DARKLUA_TYPE_B) -> Row__DARKLUA_TYPE_B,
}

type StackProperties__DARKLUA_TYPE_C = Frame__DARKLUA_TYPE_g & {
	Padding: UDim?,
	HorizontalAlignment: Enum.HorizontalAlignment?,
	VerticalAlignment: Enum.VerticalAlignment?,
}

type Stack__DARKLUA_TYPE_D = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & StackProperties__DARKLUA_TYPE_C

type TitleStackProperties__DARKLUA_TYPE_E = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Subtitle: string?,
}

type TitleStack__DARKLUA_TYPE_F = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & TitleStackProperties__DARKLUA_TYPE_E

type PageSectionProperties__DARKLUA_TYPE_G = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Subtitle: string?,
}

type PageSection__DARKLUA_TYPE_H = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & PageSectionProperties__DARKLUA_TYPE_G

type PageProperties__DARKLUA_TYPE_I = Frame__DARKLUA_TYPE_g

type Page__DARKLUA_TYPE_J = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & PageProperties__DARKLUA_TYPE_I

type LabelProperties__DARKLUA_TYPE_K = TextLabel__DARKLUA_TYPE_h

type Label__DARKLUA_TYPE_L = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & LabelProperties__DARKLUA_TYPE_K

type SymbolProperties__DARKLUA_TYPE_M = ImageLabel__DARKLUA_TYPE_j & {
	Style: ("Primary" | "Secondary")?,
}

type Symbol__DARKLUA_TYPE_N = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & SymbolProperties__DARKLUA_TYPE_M

type ToggleProperties__DARKLUA_TYPE_O = Frame__DARKLUA_TYPE_g & {
	Value: boolean?,
	ValueChanged: ((self: Toggle__DARKLUA_TYPE_P, value: boolean) -> unknown)?,
}

type Toggle__DARKLUA_TYPE_P = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & ToggleProperties__DARKLUA_TYPE_O

type TextFieldProperties__DARKLUA_TYPE_Q = Frame__DARKLUA_TYPE_g & {
	Placeholder: string?,
	Value: string?,
	TextChanged: ((self: TextField__DARKLUA_TYPE_R, text: string) -> unknown)?,
	ValueChanged: ((self: TextField__DARKLUA_TYPE_R, value: string) -> unknown)?,
}

type TextField__DARKLUA_TYPE_R = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & TextFieldProperties__DARKLUA_TYPE_Q

type KeybindFieldProperties__DARKLUA_TYPE_S = Frame__DARKLUA_TYPE_g & {
	Placeholder: string?,
	Value: Enum.KeyCode?,
	BindPressed: ((
		self: KeybindField__DARKLUA_TYPE_T,
		value: Enum.KeyCode,
		inputComplete: boolean,
		gameProcessedEvent: boolean
	) -> unknown)?,
	ValueChanged: ((self: KeybindField__DARKLUA_TYPE_T, value: Enum.KeyCode) -> unknown)?,
}

type KeybindField__DARKLUA_TYPE_T = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & KeybindFieldProperties__DARKLUA_TYPE_S

type SliderProperties__DARKLUA_TYPE_U = ImageLabel__DARKLUA_TYPE_j & {
	Minimum: number?,
	Maximum: number?,
	Value: number?,
	ValueChanged: ((self: Slider__DARKLUA_TYPE_V, value: number) -> unknown)?,
}

type Slider__DARKLUA_TYPE_V = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & SliderProperties__DARKLUA_TYPE_U

type ButtonProperties__DARKLUA_TYPE_W = TextButton__DARKLUA_TYPE_l & {
	State: ("Primary" | "Secondary" | "Destructive")?,
	Label: string?,
	Pushed: ((self: Button__DARKLUA_TYPE_X) -> unknown)?,
}

type Button__DARKLUA_TYPE_X = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & ButtonProperties__DARKLUA_TYPE_W

type StepperProperties__DARKLUA_TYPE_Y = ImageLabel__DARKLUA_TYPE_j & {
	Minimum: number?,
	Maximum: number?,
	Step: number?,
	Fielded: boolean?,
	Value: number?,
	ValueChanged: ((self: Stepper__DARKLUA_TYPE_Z, value: number) -> unknown)?,
}

type Stepper__DARKLUA_TYPE_Z = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & StepperProperties__DARKLUA_TYPE_Y & {
	Increment: () -> nil,
	Decrement: () -> nil,
}

type RadioButtonGroupProperties__DARKLUA_TYPE__ = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Value: number?,
	ValueChanged: ((self: RadioButtonGroup__DARKLUA_TYPE_0, value: number) -> unknown)?,
}

type RadioButtonGroup__DARKLUA_TYPE_0 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & RadioButtonGroupProperties__DARKLUA_TYPE__ & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
}

type PopUpButtonProperties__DARKLUA_TYPE_1 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Expanded: boolean?,
	Maximum: number?,
	Value: (number | { number })?,
	ValueChanged: ((self: PopUpButton__DARKLUA_TYPE_2, value: number | { number }) -> unknown)?,
}

type PopUpButton__DARKLUA_TYPE_2 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & PopUpButtonProperties__DARKLUA_TYPE_1 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}

type PullDownButtonProperties__DARKLUA_TYPE_3 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Expanded: boolean?,
	Label: string?,
	Value: number?,
	ValueChanged: ((self: PullDownButton__DARKLUA_TYPE_4, value: number) -> unknown)?,
}

type PullDownButton__DARKLUA_TYPE_4 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & PullDownButtonProperties__DARKLUA_TYPE_3 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}

type NotificationProperties__DARKLUA_TYPE_5 = Frame__DARKLUA_TYPE_g & {
	Title: string,
	Subtitle: string,
	App: string?,
	AppIcon: string?,
	Icon: string?,
	Duration: number?,
	Closed: ((self: Notification__DARKLUA_TYPE_6) -> unknown)?,
}

type Notification__DARKLUA_TYPE_6 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_7 & NotificationProperties__DARKLUA_TYPE_5 & {
	Close: (self: Notification__DARKLUA_TYPE_6) -> nil,
}

type Components__DARKLUA_TYPE_7 = {
	Window: (self: any, properties: WindowProperties__DARKLUA_TYPE_s?) -> Window__DARKLUA_TYPE_t,
	Section: (self: any, properties: SectionProperties__DARKLUA_TYPE_u?) -> Section__DARKLUA_TYPE_v,
	Tab: (self: any, properties: TabProperties__DARKLUA_TYPE_w?) -> Tab__DARKLUA_TYPE_x,
	Page: (self: any, properties: PageProperties__DARKLUA_TYPE_I?) -> Page__DARKLUA_TYPE_J,
	Form: (self: any, properties: FormProperties__DARKLUA_TYPE_y?) -> Form__DARKLUA_TYPE_z,
	Row: (self: any, properties: RowProperties__DARKLUA_TYPE_A?) -> Row__DARKLUA_TYPE_B,
	VStack: (self: any, properties: StackProperties__DARKLUA_TYPE_C?) -> Stack__DARKLUA_TYPE_D,
	HStack: (self: any, properties: StackProperties__DARKLUA_TYPE_C?) -> Stack__DARKLUA_TYPE_D,
	TitleStack: (self: any, properties: TitleStackProperties__DARKLUA_TYPE_E?) -> TitleStack__DARKLUA_TYPE_F,
	PageSection: (self: any, properties: PageSectionProperties__DARKLUA_TYPE_G?) -> PageSection__DARKLUA_TYPE_H,
	Label: (self: any, properties: LabelProperties__DARKLUA_TYPE_K) -> Label__DARKLUA_TYPE_L,
	Symbol: (self: any, properties: SymbolProperties__DARKLUA_TYPE_M) -> Symbol__DARKLUA_TYPE_N,
	Toggle: (self: any, properties: ToggleProperties__DARKLUA_TYPE_O) -> Toggle__DARKLUA_TYPE_P,
	TextField: (self: any, properties: TextFieldProperties__DARKLUA_TYPE_Q) -> TextField__DARKLUA_TYPE_R,
	KeybindField: (self: any, properties: KeybindFieldProperties__DARKLUA_TYPE_S) -> KeybindField__DARKLUA_TYPE_T,
	Slider: (self: any, properties: SliderProperties__DARKLUA_TYPE_U) -> Slider__DARKLUA_TYPE_V,
	Button: (self: any, properties: ButtonProperties__DARKLUA_TYPE_W) -> Button__DARKLUA_TYPE_X,
	Stepper: (self: any, properties: StepperProperties__DARKLUA_TYPE_Y) -> Stepper__DARKLUA_TYPE_Z,
	RadioButtonGroup: (self: any, properties: RadioButtonGroupProperties__DARKLUA_TYPE__) -> RadioButtonGroup__DARKLUA_TYPE_0,
	PopUpButton: (self: any, properties: PopUpButtonProperties__DARKLUA_TYPE_1) -> PopUpButton__DARKLUA_TYPE_2,
	PullDownButton: (self: any, properties: PullDownButtonProperties__DARKLUA_TYPE_3) -> PullDownButton__DARKLUA_TYPE_4,
	Notification: (self: any, properties: NotificationProperties__DARKLUA_TYPE_5) -> Notification__DARKLUA_TYPE_6,
}
...
return function(self, properties: WindowProperties__DARKLUA_TYPE_s): Window__DARKLUA_TYPE_t	--// Imports
...
local effects = __DIST.h()
	...
	do -- Page searching
		local field = structures.Titlebar.SearchField.Field
            local pageCaches = setmetatable({}, { __mode = "k" })  -- weak keys

            local function toCache(page, descendants)
                local cache = setmetatable({}, { __mode = "k" })  -- ✅ weak references
	...
	binder.Apply(properties, object)
        ...
        if not isMobile then
            local function recheck()
                local descendants = structures.Body:GetDescendants()
                for i = 1, #descendants do
                    local v = descendants[i]
                    local ok, size = pcall(function() return v.Size end)
...
return function(self, properties: SectionProperties__DARKLUA_TYPE_u): Section__DARKLUA_TYPE_v	--// Imports
...
local creator = __DIST.d()
	...
	local bindings = {
        ...
        Expanded = function(state: boolean, tween: boolean?)
            local useTween = (tween == nil) or tween 
            ...
            local updateSize = function(shouldTween: boolean)
                local targetHeight = state and structures.Layout.AbsoluteContentSize.Y or 23
                local tweenObject = tweenService:Create(
                    sidebarGroup,
                    TweenInfo.new(shouldTween and 0.35 or 0, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out),
...
return function(self, properties: PageProperties__DARKLUA_TYPE_I)
    --// Imports
    local creator = __DIST.d()
    local binder = __DIST.c()
...
return function(self, properties: TabProperties__DARKLUA_TYPE_w): Tab__DARKLUA_TYPE_x	--// Imports
...
local creator = __DIST.d()
	...
	object.Navigate = function(self, targetPage: Page__DARKLUA_TYPE_J)
	...
	if window then
		...
		structures.Body.MouseButton1Click:Connect(function()
			...
			for _, tab: Tab__DARKLUA_TYPE_x in pairs(window.Tabs) do
				tab.Selected = false
			end
...
return function(self, properties: PageSectionProperties__DARKLUA_TYPE_G): PageSection__DARKLUA_TYPE_H	--// Imports
...
return function(self, properties: Frame__DARKLUA_TYPE_g): Form__DARKLUA_TYPE_z	--// Imports
...
return function(self, properties: RowProperties__DARKLUA_TYPE_A): Row__DARKLUA_TYPE_B	--// Imports
...
return function(self, properties: StackProperties__DARKLUA_TYPE_C): Stack__DARKLUA_TYPE_D	--// Imports
...
return function(self, properties: TitleStackProperties__DARKLUA_TYPE_E): TitleStack__DARKLUA_TYPE_F	--// Imports
...
return function(self, properties: LabelProperties__DARKLUA_TYPE_K): Label__DARKLUA_TYPE_L	--// Imports
...
return function(self, properties: SymbolProperties__DARKLUA_TYPE_M): Symbol__DARKLUA_TYPE_N	--// Imports
...
return function(self, properties: TextFieldProperties__DARKLUA_TYPE_Q): TextField__DARKLUA_TYPE_R	--// Imports
...
return function(self, properties: KeybindFieldProperties__DARKLUA_TYPE_S): KeybindFieldProperties__DARKLUA_TYPE_S	--// Imports
...
return function(self, properties: SliderProperties__DARKLUA_TYPE_U): Slider__DARKLUA_TYPE_V	--// Imports
...
return function(self, properties: ButtonProperties__DARKLUA_TYPE_W): Button__DARKLUA_TYPE_X	--// Imports
...
return function(self, properties: StepperProperties__DARKLUA_TYPE_Y): Stepper__DARKLUA_TYPE_Z	--// Imports
...
local create = creator.Create
    ...
    local function stepStart(direction: string)
        ...
        stepConnections[direction] = task.spawn(function()
            ...
            local count = 0
            while holding and count < MAX_REPEAT do
                action()
                count += 1
...
return function(self, properties: RadioButtonGroupProperties__DARKLUA_TYPE__): RadioButtonGroup__DARKLUA_TYPE_0	--// Imports
...
return function(self, properties: PopUpButtonProperties__DARKLUA_TYPE_1): PopUpButton__DARKLUA_TYPE_2	--// Imports
...
local creator = __DIST.d()
    ...
    local inputConn = userInputService.InputBegan:Connect(function(input)
        ...
        then
            ...
            if
                mouse.X < pos.X or mouse.X > pos.X + size.X
                or adjustedMouseY < pos.Y or adjustedMouseY > pos.Y + size.Y
            then
                object.Expanded = false
            end
        end
...
return function(self, properties: PullDownButtonProperties__DARKLUA_TYPE_3): PullDownButton__DARKLUA_TYPE_4	--// Imports
...
local creator = __DIST.d()
    ...
    local Search = properties.Search == true
    ...
    local function updateOptions(object)
        if object.Multi then
            local selected = {}
            for _, v in ipairs(object.Value or {}) do
                selected[v] = true
            end

            for i, opt in ipairs(structures.Options) do
                if opt then
                    opt.BackgroundTransparency = selected[i] and 0 or 1
                end
            end
        else
            ...
            for i, opt in ipairs(structures.Options) do
                if opt then
                    opt.BackgroundTransparency = (value == i) and 0 or 1
                end
            end
        end
    end
    ...
    local function option(object, name, index)
        ...
        option = create("TextButton")({
            ...
            __contextKeys = {
                BackgroundTransparency = function()
                    ...
                    if object.Multi then
                        local selected = table.find(object.Value or {}, index)
                        return selected and 0 or 1
                    end

                    return (object.Value == index) and 0 or
                        (option.GuiState == Enum.GuiState.Hover and self.Theme.Controls.SelectionFocused[2].Value or 1)
                end,
            },
        ...
        option.MouseButton1Click:Connect(function()
            if object.Multi then
                ...
                local pos = table.find(object.Value, index)

                if pos then
                    table.remove(object.Value, pos)
                else
                    table.insert(object.Value, index)
                end
            else
                object.Expanded = false
                object.Value = index
            ...
            if properties.ValueChanged then
                task.spawn(properties.ValueChanged, object, object.Value)
            end
        end)
    end
    ...
    if Search then
        structures.SearchBar = create("TextBox")({
            Name = "SearchBar",
...
--[[     structures.NoResults = create("TextLabel")({
        Name = "NoResults",
    ...
    local function filterOptions(text)
        ...
        for _, opt in ipairs(structures.Options) do
            if opt then
                ...
                if lbl then
                    local show = text == "" or string.find(string.lower(lbl.Text), text, 1, true)
                    opt.Visible = show
                    if show then
                        found = true
                    end
...
--[[         if structures.NoResults then
            structures.NoResults.Visible = not found
        end ]]
    end

    if Search then
        structures.SearchBar:GetPropertyChangedSignal("Text"):Connect(function()
            filterOptions(structures.SearchBar.Text)
        end)
    end
	...
	local bindings = {
		...
		Expanded = function(value: boolean)
            ...
            if not expand and object.Search then
                structures.SearchBar.Text = ""
                filterOptions("")
            end
...
return function(self: any, properties: NotificationProperties__DARKLUA_TYPE_5, state: { Age: number }, MAX_NOTIFICATIONS: number)
	local creator = __DIST.d()
...
return function(self, properties: NotificationProperties__DARKLUA_TYPE_5): Notification__DARKLUA_TYPE_6	
local services = __DIST.e()
	local binder = __DIST.c()
...
return {
    ...
    OLED         = __DIST.OLED(),
    Solarized    = __DIST.Solarized(),
    RoseGold     = __DIST.RoseGold(),
    Forest       = __DIST.Forest(),
    HighContrast = __DIST.HighContrast(),
...
return {
	Blue = {
		...
		Dark = {
		    ...
		    SelectionStroke =  Color3.fromHex("#0A82FF"),
	...
	Teal = {
		...
		Dark = {
			...
			SelectionFocused = Color3.fromHex("#84DCFF"),
			SelectionStroke = Color3.fromHex("#84DCFF"),
			Toggle = { SwitchOn = Color3.fromHex("#64D2FF") },
			Button = { FillPrimary = makeGradient("#84DCFF", "#32B4E6") },
		},
		Light = {
			...
			Button = { FillPrimary = makeGradient("#7FD5FB", "#2DADE2") },
		},
	},
	...
	Indigo = {
		_id = "Indigo",
		Dark = {
			SwitchAccent = Color3.fromHex("#5E5CE6"),
			Selection = Color3.fromHex("#5E5CE6"),
			SelectionFocused = Color3.fromHex("#7A78ED"),
			SelectionStroke = Color3.fromHex("#7A78ED"),
			Toggle = { SwitchOn = Color3.fromHex("#5E5CE6") },
			Button = { FillPrimary = makeGradient("#7A78ED", "#4340C9") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#5856D6"),
			Selection = Color3.fromHex("#5856D6"),
			SelectionFocused = Color3.fromHex("#7674DF"),
			SelectionStroke = Color3.fromHex("#7674DF"),
			Toggle = { SwitchOn = Color3.fromHex("#5856D6") },
			Button = { FillPrimary = makeGradient("#7674DF", "#3D3BB8") },
		},
	},
	...
	Mint = {
		...
		Dark = {
			...
			SelectionFocused = Color3.fromHex("#86ECD3"),
			SelectionStroke = Color3.fromHex("#86ECD3"),
			Toggle = { SwitchOn = Color3.fromHex("#66E6C5") },
			Button = { FillPrimary = makeGradient("#86ECD3", "#3CC9A5") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#00C7BE"),
			Selection = Color3.fromHex("#00C7BE"),
			SelectionFocused = Color3.fromHex("#33D3CC"),
			SelectionStroke = Color3.fromHex("#33D3CC"),
			Toggle = { SwitchOn = Color3.fromHex("#00C7BE") },
			Button = { FillPrimary = makeGradient("#33D3CC", "#00A39C") },
		},
	},
	...
	Brown = {
		...
		Dark = {
			...
			SelectionFocused = Color3.fromHex("#BCA182"),
			SelectionStroke = Color3.fromHex("#BCA182"),
			Toggle = { SwitchOn = Color3.fromHex("#AC8E68") },
			Button = { FillPrimary = makeGradient("#BCA182", "#8D7050") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#A2845E"),
			Selection = Color3.fromHex("#A2845E"),
			SelectionFocused = Color3.fromHex("#B19775"),
			SelectionStroke = Color3.fromHex("#B19775"),
			Toggle = { SwitchOn = Color3.fromHex("#A2845E") },
			Button = { FillPrimary = makeGradient("#B19775", "#856848") },
		},
	},
	Cyan = {
		_id = "Cyan",
		Dark = {
			SwitchAccent = Color3.fromHex("#32D7FF"),
			Selection = Color3.fromHex("#32D7FF"),
			SelectionFocused = Color3.fromHex("#5BE0FF"),
			SelectionStroke = Color3.fromHex("#5BE0FF"),
			Toggle = { SwitchOn = Color3.fromHex("#32D7FF") },
			Button = { FillPrimary = makeGradient("#5BE0FF", "#0BB7E0") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#00CFFF"),
			Selection = Color3.fromHex("#00CFFF"),
			SelectionFocused = Color3.fromHex("#33D9FF"),
			SelectionStroke = Color3.fromHex("#33D9FF"),
			Toggle = { SwitchOn = Color3.fromHex("#00CFFF") },
			Button = { FillPrimary = makeGradient("#33D9FF", "#00ACD4") },
		},
	},
	Lime = {
		_id = "Lime",
		Dark = {
			SwitchAccent = Color3.fromHex("#A8E63A"),
			Selection = Color3.fromHex("#A8E63A"),
			SelectionFocused = Color3.fromHex("#B9EB63"),
			SelectionStroke = Color3.fromHex("#B9EB63"),
			Toggle = { SwitchOn = Color3.fromHex("#A8E63A") },
			Button = { FillPrimary = makeGradient("#B9EB63", "#82BA19") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#9AD92B"),
			Selection = Color3.fromHex("#9AD92B"),
			SelectionFocused = Color3.fromHex("#AFE255"),
			SelectionStroke = Color3.fromHex("#AFE255"),
			Toggle = { SwitchOn = Color3.fromHex("#9AD92B") },
			Button = { FillPrimary = makeGradient("#AFE255", "#76B012") },
		},
	},
	Amber = {
		_id = "Amber",
		Dark = {
			SwitchAccent = Color3.fromHex("#FFC233"),
			Selection = Color3.fromHex("#FFC233"),
			SelectionFocused = Color3.fromHex("#FFCF5C"),
			SelectionStroke = Color3.fromHex("#FFCF5C"),
			Toggle = { SwitchOn = Color3.fromHex("#FFC233") },
			Button = { FillPrimary = makeGradient("#FFCF5C", "#D99B00") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#FFB300"),
			Selection = Color3.fromHex("#FFB300"),
			SelectionFocused = Color3.fromHex("#FFC533"),
			SelectionStroke = Color3.fromHex("#FFC533"),
			Toggle = { SwitchOn = Color3.fromHex("#FFB300") },
			Button = { FillPrimary = makeGradient("#FFC533", "#D68F00") },
		},
	},
	DeepOrange = {
		_id = "DeepOrange",
		Dark = {
			SwitchAccent = Color3.fromHex("#FF7A33"),
			Selection = Color3.fromHex("#FF7A33"),
			SelectionFocused = Color3.fromHex("#FF965C"),
			SelectionStroke = Color3.fromHex("#FF965C"),
			Toggle = { SwitchOn = Color3.fromHex("#FF7A33") },
			Button = { FillPrimary = makeGradient("#FF965C", "#D95500") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#FF6A00"),
			Selection = Color3.fromHex("#FF6A00"),
			SelectionFocused = Color3.fromHex("#FF8633"),
			SelectionStroke = Color3.fromHex("#FF8633"),
			Toggle = { SwitchOn = Color3.fromHex("#FF6A00") },
			Button = { FillPrimary = makeGradient("#FF8633", "#D94F00") },
		},
	},
	Rose = {
		_id = "Rose",
		Dark = {
			SwitchAccent = Color3.fromHex("#FF5C8A"),
			Selection = Color3.fromHex("#FF5C8A"),
			SelectionFocused = Color3.fromHex("#FF7AA0"),
			SelectionStroke = Color3.fromHex("#FF7AA0"),
			Toggle = { SwitchOn = Color3.fromHex("#FF5C8A") },
			Button = { FillPrimary = makeGradient("#FF7AA0", "#D63261") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#FF4D7A"),
			Selection = Color3.fromHex("#FF4D7A"),
			SelectionFocused = Color3.fromHex("#FF6B91"),
			SelectionStroke = Color3.fromHex("#FF6B91"),
			Toggle = { SwitchOn = Color3.fromHex("#FF4D7A") },
			Button = { FillPrimary = makeGradient("#FF6B91", "#D62857") },
		},
	},
	DeepPurple = {
		_id = "DeepPurple",
		Dark = {
			SwitchAccent = Color3.fromHex("#8A5CFF"),
			Selection = Color3.fromHex("#8A5CFF"),
			SelectionFocused = Color3.fromHex("#A07AFF"),
			SelectionStroke = Color3.fromHex("#A07AFF"),
			Toggle = { SwitchOn = Color3.fromHex("#8A5CFF") },
			Button = { FillPrimary = makeGradient("#A07AFF", "#6633D6") },
		},
		Light = {
			SwitchAccent = Color3.fromHex("#7B4DFF"),
			Selection = Color3.fromHex("#7B4DFF"),
			SelectionFocused = Color3.fromHex("#9570FF"),
			SelectionStroke = Color3.fromHex("#9570FF"),
			Toggle = { SwitchOn = Color3.fromHex("#7B4DFF") },
			Button = { FillPrimary = makeGradient("#9570FF", "#5B28D6") },
		},
	},
}
